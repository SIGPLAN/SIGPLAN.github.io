...
The OOPSLA Steering Committee is a strict subset of the [SPLASH Steering Committee](/Conferences/SPLASH) and consists of the past three OOPSLA RC (co-)chairs and present and future RC (co-)chairs and has its own mailing list for discussing OOPSLA specific issues. The SPLASH SC Chair is also a member of this committee and is the committee chair by default but can choose to delegate the chair position if desired.

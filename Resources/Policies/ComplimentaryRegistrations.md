...
Complimentary registrations and possible travel support for economy-class return airfare and hotel during the conference (if there is no funding) are thus allowed *only* for these roles:

   * Plenary keynote speakers for the main conference (typically at most 2 or 3 during a single event).
   * Student volunteer chair(s) (a maximum of 1 being the senior SV chair if there are two).

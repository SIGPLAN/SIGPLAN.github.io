---
layout: default
title: "Conference Submission Review Policy"
---

**Confidentiality**

Submissions must be treated as confidential and must not be distributed
or disclosed except to people explicitly authorized by the PCC for the
purpose of review. Reviewers must not copy submissions, pass them to
other people, or discuss them with anyone who is not authorized to
participate in the review process. Confidentiality continues until the
work has been publicly released by the authors or publisher. The PCC
must keep a record of all external reviewers.
...
Submission metadata, acceptance status, and decision summaries may be
shared with another authorized SIGPLAN process, such as a related review
committee or artifact-evaluation committee, when necessary for that
process. Only the information needed for the stated purpose should be
shared, and all recipients must observe the applicable confidentiality
requirements.
...
should decline to review a paper. 
...
objective judgment for any reason, they should notify the
program chair.

If the PCC has a conflict of interest with a submission, the PCC must
not have access to or participate in its reviewing, discussion, or
decision. Another qualified committee member must manage the submission
independently.


**Use of generative AI or LLM systems**

Please see the [FAQ for the general ACM policy](https://www.acm.org/publications/policies/peer-review-faq). 
In particular:

1. *Confidentiality of submissions*. Reviewers may not upload or paste a submission, or any parts of its content, into any generative AI or LLM system, or any other third-party service, that does not guarantee the confidentiality of the submitted material.
2. *Integrity of reviews*. Reviewers are expected to personally read, evaluate, and form judgments about submissions. AI tools should not be used as substitutes for the reviewer's expertise or judgment. AI may be used to correct spelling, grammar, and presentation, and to improve the clarity of reviewer-written text (provided that confidentiality is ensured). Reviewers remain fully responsible for the contents of their reviews, including any text that has been edited or generated with AI assistance.
...
SIGPLAN conferences should strive to ensure that every submission is
reviewed by people with sufficient relevant expertise. Review teams may
combine complementary areas of expertise, and well-informed non-expert
...
Conferences may allow authors to submit supplementary material (examples, proofs, software, datasets, etc.) at the time of submission. 
The PC may, but is not required to, consider this material.
Supplementary material should be anonymized for double-blind reviewing. 
...
PC submissions can be problematic to manage, but, on balance, the benefits of allowing PC submissions exceed the costs, so conferences should allow PC submissions.

If Program Committee members are allowed to submit papers, either their papers should be held to a higher standard or other EC-approved measures should be taken, to avoid the appearance of impropriety.
Conferences that use full double-blind reviewing and have program committees with at least fifty members need not hold PC papers to a higher standard, as the EC has judged that these are sufficient conditions to avoid the appearance of impropriety.
...
Acceptance decisions for PC papers should be communicated at the same time as decisions for other submissions.


The Program Chair (PCC) may not submit papers to the conference; SIGPLAN’s Executive Committee recommends that the General Chair (GC) also not be allowed to submit papers.

**Author Response**

SIGPLAN conferences typically allow author responses to reviewers. Authors should be allowed to read all reviews that are available at the time of the author response period.  The PCC should make every effort to complete all initial reviews before the author-response period.  Additional reviews may be solicited after the author response period and it may not be possible for the authors to see these reviews before final decisions are made by the PC.  Ideally, authors should be allowed at least four days to respond.
Additionally:

- Authors strongly prefer seeing the overall merit score at author response time. The PCC should consider making the scores available as well as the reviews.
- The PCC may choose whether to make reviewer expertise scores visible to authors. The main purpose of these scores is to help the PCC assess whether the reviewers have sufficient expertise, and keeping them internal may help focus author responses on the substance of the reviews. 
